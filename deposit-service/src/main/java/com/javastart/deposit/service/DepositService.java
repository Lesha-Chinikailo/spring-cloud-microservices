...
public class DepositService {
    ...
    private DepositResponseDTO createResponse(BigDecimal amount, AccountResponseDTO accountResponseDTO) {
        ...
        try {
            rabbitTemplate
                    .convertAndSend(TOPIC_EXCHANGE_DEPOSIT, ROUTING_KEY_DEPOSIT, objectMapper.writeValueAsString(depositResponseDTO));
    ...
    private BillResponseDTO getDefaultBill(Long accountId){
        return billServiceClient.getBillsByAccountId(accountId)
                ...
                .findAny()
                .orElseThrow(() -> new DepositServiceException("Unable to find default bill by account id " + accountId));
    }
}
